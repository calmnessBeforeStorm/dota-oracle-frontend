...
9. **Сетки турнира нет и не будет из этих данных.** У серии нет ни раунда, ни связи
...
10. **Дашборд точности не имеет права льстить.** Три правила, каждое ловит свой способ
...
11. **Типы API — зеркало бэкенда.** При изменении схем править `src/api/types.ts` в том же PR;
